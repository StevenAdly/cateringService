...
move_speed:a.particles.move.speed,line_linked_distance:a.particles.line_linked.distance,line_linked_width:a.particles.line_linked.width,mode_grab_distance:a.interactivity.modes.grab.distance,mode_bubble_distance:a.interactivity.modes.bubble.distance,mode_bubble_size:a.interactivity.modes.bubble.size,mode_repulse_distance:a.interactivity.modes.repulse.distance};a.tmp.count_svg=0;a.fn.retinaInit=function(){a.retina_detect&&1<window.devicePixelRatio?(a.steven.pxratio=window.devicePixelRatio,a.tmp.retina=
!0):(a.steven.pxratio=1,a.tmp.retina=!1);a.steven.w=a.steven.el.offsetWidth*a.steven.pxratio;a.steven.h=a.steven.el.offsetHeight*a.steven.pxratio;a.particles.size.value=a.tmp.obj.size_value*a.steven.pxratio;a.particles.size.anim.speed=a.tmp.obj.size_anim_speed*a.steven.pxratio;a.particles.move.speed=a.tmp.obj.move_speed*a.steven.pxratio;a.particles.line_linked.distance=a.tmp.obj.line_linked_distance*a.steven.pxratio;a.interactivity.modes.grab.distance=a.tmp.obj.mode_grab_distance*a.steven.pxratio;
a.interactivity.modes.bubble.distance=a.tmp.obj.mode_bubble_distance*a.steven.pxratio;a.particles.line_linked.width=a.tmp.obj.line_linked_width*a.steven.pxratio;a.interactivity.modes.bubble.size=a.tmp.obj.mode_bubble_size*a.steven.pxratio;a.interactivity.modes.repulse.distance=a.tmp.obj.mode_repulse_distance*a.steven.pxratio};a.fn.stevenInit=function(){a.steven.ctx=a.steven.el.getContext("2d")};a.fn.stevenSize=function(){a.steven.el.width=a.steven.w;a.steven.el.height=a.steven.h;a&&a.interactivity.events.resize&&
window.addEventListener("resize",function(){a.interactivity.offset=l.offset();a.steven.w=a.steven.el.offsetWidth;a.steven.h=a.steven.el.offsetHeight;a.tmp.retina&&(a.steven.w*=a.steven.pxratio,a.steven.h*=a.steven.pxratio);a.steven.el.width=a.steven.w;a.steven.el.height=a.steven.h;a.particles.move.enable||(a.fn.particlesEmpty(),a.fn.particlesCreate(),a.fn.particlesDraw(),a.fn.vendors.densityAutoParticles());a.fn.vendors.densityAutoParticles()})};a.fn.stevenPaint=function(){a.steven.ctx.fillRect(0,
0,a.steven.w,a.steven.h)};a.fn.stevenClear=function(){a.steven.ctx.clearRect(0,0,a.steven.w,a.steven.h)};a.fn.particle=function(b,c,d){c=a.particles.size.value;if(a.particles.size.random){var h=a.particles.size.min;c=Math.random()*(c-h)+h;0===c&&(c=1)}this.osize=this.radius=c;a.particles.size.anim.enable&&(this.size_status=!1,this.vs=a.particles.size.anim.speed/100,a.particles.size.anim.sync||(this.vs*=Math.random()));this.x=d?d.x:Math.random()*a.steven.w;this.y=d?d.y:Math.random()*a.steven.h;this.x>
a.steven.w-2*this.radius?this.x-=this.radius:this.x<2*this.radius&&(this.x+=this.radius);this.y>a.steven.h-2*this.radius?this.y-=this.radius:this.y<2*this.radius&&(this.y+=this.radius);a.particles.move.bounce&&a.fn.vendors.checkOverlap(this,d);d=a.particles.move.speed;c=a.particles.move.min_speed;a.particles.move.random&&(d=Math.round(Math.random()*(d-c)+c),1>d&&(d=1));this.spd=d;this.color={};"object"==typeof b.value?b.value instanceof Array?this.color.rgb=t(b.value[Math.floor(Math.random()*a.particles.color.value.length)]):
...
ratio:b.image.width/b.image.height},this.img.ratio||(this.img.ratio=1),"svg"==a.tmp.img_type&&void 0!=a.tmp.source_svg&&(a.fn.vendors.createSvgImg(this),a.tmp.pushing&&(this.img.loaded=!1)))};a.fn.particle.prototype.drawSVG=function(b,c){a.steven.ctx.drawImage(b,this.x-c,this.y-c,2*c,2*c/this.img.ratio)};a.fn.particle.prototype.draw=function(){var b,c,d;c=void 0!=this.radius_bubble?this.radius_bubble:this.radius;d=void 0!=this.opacity_bubble?this.opacity_bubble:this.opacity;a.steven.ctx.fillStyle=
this.color.rgb?"rgba("+this.color.rgb.r+","+this.color.rgb.g+","+this.color.rgb.b+","+d+")":"hsla("+this.color.hsl.h+","+this.color.hsl.s+"%,"+this.color.hsl.l+"%,"+d+")";a.steven.ctx.beginPath();switch(this.shape){case "circle":a.steven.ctx.arc(this.x,this.y,c,0,2*Math.PI,!1);break;case "edge":a.steven.ctx.rect(this.x-c,this.y-c,2*c,2*c);break;case "triangle":a.fn.vendors.drawShape(a.steven.ctx,this.x-c,this.y+c/1.66,2*c,3,2);break;case "polygon":a.fn.vendors.drawShape(a.steven.ctx,this.x-c/(a.particles.shape.polygon.nb_sides/
3.5),this.y-c/.76,2.66*c/(a.particles.shape.polygon.nb_sides/3),a.particles.shape.polygon.nb_sides,1);break;case "star":a.fn.vendors.drawShape(a.steven.ctx,this.x-2*c/(a.particles.shape.polygon.nb_sides/4),this.y-c/1.52,5.32*c/(a.particles.shape.polygon.nb_sides/3),a.particles.shape.polygon.nb_sides,2);break;case "image":a.steven.ctx.globalAlpha=d,(b="svg"==a.tmp.img_type?this.img.obj:a.tmp.img_obj)&&this.drawSVG(b,c),a.steven.ctx.globalAlpha=1,b=!0}a.steven.ctx.closePath();b||(0<a.particles.shape.stroke.width&&
(a.steven.ctx.strokeStyle=this.strokeColor,a.steven.ctx.lineWidth=a.particles.shape.stroke.width,a.steven.ctx.stroke()),a.steven.ctx.fill())};a.fn.particlesCreate=function(){for(var b=a.particles.number.value,c=a.particles.array,d=0;d<b;d++)c[c.length]=new a.fn.particle(a.particles.color,a.particles.opacity.value)};a.fn.particlesUpdate=function(){for(var b,c,d,h,f=a.particles.array.length,g=0;g<f;g++){var e=a.particles.array[g];a.particles.move.enable&&(b=e.spd/2,e.x+=e.vx*b,e.y+=e.vy*b);a.particles.opacity.anim.enable&&
(1==e.opacity_status?(e.opacity>=e.opc&&(e.opacity_status=!1),e.opacity+=e.vo):(e.opacity<=a.particles.opacity.anim.opacity_min&&(e.opacity_status=!0),e.opacity-=e.vo),0>e.opacity&&(e.opacity=0));a.particles.size.anim.enable&&(1==e.size_status?(e.radius>=a.particles.size.value&&(e.size_status=!1),e.radius+=e.vs):(e.radius<=a.particles.size.anim.size_min&&(e.size_status=!0),e.radius-=e.vs),0>e.radius&&(e.radius=0));"bounce"==a.particles.move.out_mode?(b=e.radius,c=a.steven.w,d=e.radius,h=a.steven.h):
(b=-e.radius,c=a.steven.w+e.radius,d=-e.radius,h=a.steven.h+e.radius);e.x-e.radius>a.steven.w?(e.x=b,e.y=Math.random()*a.steven.h):0>e.x+e.radius&&(e.x=c,e.y=Math.random()*a.steven.h);e.y-e.radius>a.steven.h?(e.y=d,e.x=Math.random()*a.steven.w):0>e.y+e.radius&&(e.y=h,e.x=Math.random()*a.steven.w);switch(a.particles.move.out_mode){case "bounce":e.x+e.radius>a.steven.w?e.vx=-e.vx:0>e.x-e.radius&&(e.vx=-e.vx),e.y+e.radius>a.steven.h?e.vy=-e.vy:0>e.y-e.radius&&(e.vy=-e.vy)}-1<a.interactivity.events.onhover.mode.indexOf("grab")&&
...
d),a.particles.move.attract.enable&&a.fn.interact.attractParticles(e,d),a.particles.move.bounce&&a.fn.interact.bounceParticles(e,d)}};a.fn.particlesDraw=function(){a.steven.ctx.clearRect(0,0,a.steven.w,a.steven.h);a.fn.particlesUpdate();for(var b=a.particles.array.length,c=0;c<b;c++)a.particles.array[c].draw()};a.fn.particlesEmpty=function(){a.particles.array=[]};a.fn.particlesRefresh=function(){rspCancelAnimFrame(a.fn.checkAnimFrame);rspCancelAnimFrame(a.fn.drawAnimFrame);a.tmp.source_svg=void 0;
a.tmp.img_obj=void 0;a.tmp.count_svg=0;a.fn.particlesEmpty();a.fn.stevenClear();a.fn.vendors.start()};a.fn.interact.linkParticles=function(b,c){var d=b.x-c.x,h=b.y-c.y,d=Math.sqrt(d*d+h*h);d<=a.particles.line_linked.distance&&(d=a.particles.line_linked.opacity-d/(1/a.particles.line_linked.opacity)/a.particles.line_linked.distance,0<d&&(h=b.lineColor,a.steven.ctx.strokeStyle="rgba("+h.r+","+h.g+","+h.b+","+d+")",a.steven.ctx.lineWidth=a.particles.line_linked.width,a.steven.ctx.beginPath(),a.steven.ctx.moveTo(b.x,
b.y),a.steven.ctx.lineTo(c.x,c.y),a.steven.ctx.stroke(),a.steven.ctx.closePath()))};a.fn.interact.attractParticles=function(b,c){var d=b.x-c.x,h=b.y-c.y;Math.sqrt(d*d+h*h)<=a.particles.line_linked.distance&&(d/=1E3*a.particles.move.attract.rotateX,h/=1E3*a.particles.move.attract.rotateY,b.vx-=d,b.vy-=h,c.vx+=d,c.vy+=h)};a.fn.interact.bounceParticles=function(a,c){var b=a.x-c.x,h=a.y-c.y;Math.sqrt(b*b+h*h)<=a.radius+c.radius&&(a.vx=-a.vx,a.vy=-a.vy,c.vx=-c.vx,c.vy=-c.vy)};a.fn.modes.pushParticles=
function(b,c){b|=0;a.tmp.pushing=!0;for(var d=0;d<b;d++)a.particles.array.push(new a.fn.particle(a.particles.color,a.particles.opacity.value,{x:c?c.pos_x:Math.random()*a.steven.w,y:c?c.pos_y:Math.random()*a.steven.h}));a.particles.move.enable||a.fn.particlesDraw();a.tmp.pushing=!1};a.fn.modes.removeParticles=function(b){a.particles.array.splice(0,b);a.particles.move.enable||a.fn.particlesDraw()};a.fn.modes.bubbleParticle=function(b){if(a.interactivity.events.onhover.enable&&-1<a.interactivity.events.onhover.mode.indexOf("bubble")){var c=
...
c+b.radius<a.steven.w&&(b.x=c),0<d-b.radius&&d+b.radius<a.steven.h&&(b.y=d)):(b.x=c,b.y=d)}else a.interactivity.events.onclick.enable&&-1<a.interactivity.events.onclick.mode.indexOf("repulse")&&(a.tmp.repulse_finish||(a.tmp.repulse_count++,a.tmp.repulse_count==a.particles.array.length&&(a.tmp.repulse_finish=!0)),a.tmp.repulse_clicking?(c=Math.pow(a.interactivity.modes.repulse.distance/6,3),f=a.interactivity.mouse.click_pos_x-b.x,h=a.interactivity.mouse.click_pos_y-b.y,g=f*f+h*h,d=-c/g*1,g<=c&&(c=
Math.atan2(h,f),b.vx=d*Math.cos(c),b.vy=d*Math.sin(c),"bounce"==a.particles.move.out_mode&&(c=b.x+b.vx,d=b.y+b.vy,c+b.radius>a.steven.w?b.vx=-b.vx:0>c-b.radius&&(b.vx=-b.vx),d+b.radius>a.steven.h?b.vy=-b.vy:0>d-b.radius&&(b.vy=-b.vy)))):0==a.tmp.repulse_clicking&&(b.vx=b.vx_i,b.vy=b.vy_i))};a.fn.modes.grabParticle=function(b){if(a.interactivity.events.onhover.enable&&"mousemove"==a.interactivity.status){var c=b.x-a.interactivity.mouse.pos_x,d=b.y-a.interactivity.mouse.pos_y,c=Math.sqrt(c*c+d*d);c<=
a.interactivity.modes.grab.distance&&(c=a.interactivity.modes.grab.line_linked.opacity-c/(1/a.interactivity.modes.grab.line_linked.opacity)/a.interactivity.modes.grab.distance,0<c&&(d=b.lineColor,a.steven.ctx.strokeStyle="rgba("+d.r+","+d.g+","+d.b+","+c+")",a.steven.ctx.lineWidth=a.particles.line_linked.width,a.steven.ctx.beginPath(),a.steven.ctx.moveTo(b.x,b.y),a.steven.ctx.lineTo(a.interactivity.mouse.pos_x,a.interactivity.mouse.pos_y),a.steven.ctx.stroke(),a.steven.ctx.closePath()))}};a.fn.vendors.eventsListeners=
function(){a.interactivity.el="window"==a.interactivity.detect_on?window:a.steven.el;if(a.interactivity.events.onhover.enable||a.interactivity.events.onclick.enable)l.on("mousemove.rsparticles",function(b){a.interactivity.mouse.pos_x=b.pageX-a.offset.left;a.interactivity.mouse.pos_y=b.pageY-a.offset.top;a.interactivity.status="mousemove"}),l[0].addEventListener("mouseleave",function(b){a.interactivity.mouse.pos_x=null;a.interactivity.mouse.pos_y=null;a.interactivity.status="mouseleave"});a.interactivity.events.onclick.enable&&
...
a.steven.el.width*a.steven.el.height/1E3;a.tmp.retina&&(b/=2*a.steven.pxratio);b=a.particles.array.length-b*a.particles.number.value/a.particles.number.density.value_area;0>b?a.fn.modes.pushParticles(Math.abs(b)):a.fn.modes.removeParticles(b)}};a.fn.vendors.checkOverlap=function(b,c){for(var d=a.particles.array.length,f=0;f<d;f++){var g=a.particles.array[f],k=b.x-g.x,e=b.y-g.y;Math.sqrt(k*k+e*e)<=b.radius+g.radius&&(b.x=c?c.x:Math.random()*a.steven.w,b.y=c?c.y:Math.random()*a.steven.h,a.fn.vendors.checkOverlap(b))}};
...
a.tmp.checkAnimFrame=rspRequestAnimFrame(check):(rspCancelAnimFrame(a.tmp.checkAnimFrame),a.tmp.img_error||(a.fn.vendors.init(),a.fn.vendors.draw())):(a.fn.vendors.init(),a.fn.vendors.draw())};a.fn.vendors.init=function(){a.fn.retinaInit();a.fn.stevenInit();a.fn.stevenSize();a.fn.stevenPaint();a.fn.particlesCreate();a.fn.vendors.densityAutoParticles()};a.fn.vendors.start=function(){-1<a.particles.shape.type.indexOf("image")?(a.tmp.img_type="svg",a.fn.vendors.loadImg(a.tmp.img_type,a.particles.shape.image.src)):
